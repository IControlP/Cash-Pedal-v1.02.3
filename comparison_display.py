...
def display_comparison():
    ...
    st.header(" Multi-Vehicle Comparison")
...
def display_comparison_summary():
    ...
    for i, vehicle_entry in enumerate(vehicles):
        ...
        with col1:
            ...
            status_icon = "Ã¢Å“â€¦" if has_results else " "
            ...
            if not has_results:
                st.caption("  Missing calculation results - may need to recalculate")
...
def display_executive_summary(comparison_results: Dict[str, Any], 
    ...
    if comparison_results.get('best_overall'):
        ...
        **Affordability:** {'Ã¢Å“â€¦ Good' if best_vehicle.get('is_affordable', False) else '  Marginal'}
        """)
...
def display_cost_comparison_table(comparison_results: Dict[str, Any]):
    ...
    for vehicle in vehicles:
        ...
        row = {
            ...
            'Affordable': 'Ã¢Å“â€¦' if vehicle.get('is_affordable', False) else ' '
        }
