...
class ComparisonService:
    ...
    def _generate_comparison_insights(self, vehicle_results: List[Dict[str, Any]], 
        ...
        if affordable_percentage == 100:
            insights.append("All vehicles in comparison are within your budget guidelines (â‰¤10% of income)")
        elif affordable_percentage == 0:
            insights.append("None of the vehicles meet conservative affordability guidelines (â‰¤10% of income)")
        else:
            insights.append(f"{affordable_percentage:.0f}% of vehicles meet affordability guidelines (â‰¤10% of income)")
