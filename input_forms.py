...
# Vehicle condition and pricing section
 ...
 st.warning(f" ï¸ Could not estimate used vehicle value: {str(e)}")
 estimated_price = None
 ...
 st.warning(f" ï¸ Could not load MPG data: {str(e)}")
...
def display_location_form(vehicle_data: Dict[str, Any] = None) -> Dict[str, Any]:
 ...
 auto_fuel_price = 3.50
 auto_electricity_rate = None
 st.warning(" ï¸ ZIP code not found. Please enter manually below.")
 else:
 auto_state = ''
 auto_geography = 'Suburban'
 auto_fuel_price = 3.50
...
def display_financial_parameters_form(transaction_type: str) -> Dict[str, Any]:
 ...
 st.warning(" ï¸ Zero down payment will increase monthly payments and total interest")
 elif down_payment_percent < 10:
 st.warning(" ï¸ Low down payment may require PMI or higher interest rates")
