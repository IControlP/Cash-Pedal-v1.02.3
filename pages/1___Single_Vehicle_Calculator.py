...
def main():
    ...
    with st.sidebar:
        ...
        if (
            hasattr(st.session_state, "comparison_vehicles")
            and st.session_state.comparison_vehicles
        ):
            st.success(
            ...
            st.caption(
                "Complete a calculation and click 'Add to Comparison' to start comparing vehicles."
            )
