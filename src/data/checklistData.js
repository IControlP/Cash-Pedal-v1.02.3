...
// Costs reflect 2025/2026 national average shop rates (parts + labor, non-dealer).
export const maintenanceItems = [
  // Engine / Powertrain
  { id: 'oil_change', name: 'Oil & Filter Change', interval: 7500, category: 'Powertrain', cost: 100, critical: false },
  { id: 'air_filter', name: 'Engine Air Filter', interval: 20000, category: 'Powertrain', cost: 45, critical: false },
  { id: 'cabin_filter', name: 'Cabin Air Filter', interval: 15000, category: 'Interior', cost: 45, critical: false },
  { id: 'spark_plugs', name: 'Spark Plugs (iridium/platinum)', interval: 60000, category: 'Powertrain', cost: 220, critical: false },
  { id: 'transmission_fluid', name: 'Transmission Fluid', interval: 60000, category: 'Powertrain', cost: 180, critical: true },
  { id: 'coolant_flush', name: 'Coolant Flush', interval: 50000, category: 'Powertrain', cost: 130, critical: false },
  { id: 'timing_belt', name: 'Timing Belt / Chain Inspection', interval: 60000, category: 'Powertrain', cost: 650, critical: true },
  { id: 'fuel_filter', name: 'Fuel Filter', interval: 60000, category: 'Powertrain', cost: 90, critical: false },
  // Suspension & Steering
  { id: 'tires_rotate', name: 'Tire Rotation & Balance', interval: 7500, category: 'Tires & Suspension', cost: 60, critical: false },
  { id: 'tires_replace', name: 'Tire Replacement', interval: 50000, category: 'Tires & Suspension', cost: 800, critical: true },
  { id: 'alignment', name: 'Wheel Alignment', interval: 30000, category: 'Tires & Suspension', cost: 110, critical: false },
  { id: 'shocks_struts', name: 'Shocks / Struts', interval: 60000, category: 'Tires & Suspension', cost: 950, critical: true },
  // Brakes
  { id: 'brake_pads', name: 'Brake Pads', interval: 40000, category: 'Brakes', cost: 280, critical: true },
  { id: 'brake_fluid', name: 'Brake Fluid Flush', interval: 30000, category: 'Brakes', cost: 90, critical: false },
  { id: 'brake_rotors', name: 'Brake Rotors', interval: 70000, category: 'Brakes', cost: 450, critical: true },
  // Electrical / Safety
  { id: 'battery', name: 'Battery Test / Replacement', interval: 50000, category: 'Electrical', cost: 220, critical: true },
  { id: 'lights', name: 'Light Bulb Inspection', interval: 15000, category: 'Electrical', cost: 35, critical: false },
  // Fluids
  { id: 'power_steering', name: 'Power Steering Fluid', interval: 50000, category: 'Fluids', cost: 75, critical: false },
  { id: 'differential', name: 'Differential Fluid', interval: 50000, category: 'Fluids', cost: 120, critical: false },
