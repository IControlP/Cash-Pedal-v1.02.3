...
const tools = [
  {
    ...
    desc: 'See your real monthly payment, total interest, and true annual cost — not just the sticker price. Covers loan or lease, insurance, fuel, maintenance, and registration in one number.',
    cta: 'Run the numbers',
    featured: true,
    tier: 'free',
  ...
  },
  {
    ...
    desc: 'Line up to 5 vehicles side by side — buy or lease — and instantly see which one costs less to own over time across every cost category.',
  ...
  },
  {
    ...
    desc: "How much do you need to earn to responsibly afford that $35k car? The 20/4/10 rule tells you — and shows you what you can afford on your current salary.",
  ...
  },
  {
    ...
    emoji: '🎯',
    title: 'Car Survey',
    desc: '13 questions about how you actually use a car. Get matched to your ideal vehicle type — SUV, EV, truck, sports car — with the reasoning behind your result.',
    cta: 'Find your match',
    featured: false,
    tier: 'free',
  ...
  },
  {
    ...
    desc: 'Enter the mileage, get a full maintenance audit and negotiation leverage — including a suggested offer price and the exact questions to ask the seller.',
  ...
  },
  {
    ...
    emoji: '🤖',
    title: 'Wheel-Zard AI',
    desc: 'Ask anything — "Is a 72-month loan a bad idea?" or "Should I buy or lease a Tesla?" Powered by a custom GPT built on automotive and financial data.',
    cta: 'Ask Wheel-Zard',
    featured: false,
    tier: 'free',
  },
  {
    ...
    emoji: '🔗',
    title: 'Resources',
    desc: 'Curated links for shopping, financing, insurance, maintenance research, and vehicle history — vetted tools we actually use.',
    cta: 'View resources',
    featured: false,
    tier: 'free',
  },
  {
    ...
    emoji: 'ℹ️',
    title: 'About & FAQ',
    desc: 'How Cash Pedal works, what the math includes, where the data comes from, and answers to common questions.',
    cta: 'Learn more',
    featured: false,
    tier: 'free',
  },
...
const reasons = [
  {
    ...
    body: "Open any tool, enter your numbers, get your answer. No account required — results in under 60 seconds.",
  },
  {
    icon: '🔢',
    title: 'The full cost, not just the payment.',
    body: 'Monthly payment is only part of the story. Cash Pedal shows insurance, fuel, maintenance, and registration too — because those are what actually hurt.',
  },
  {
    icon: '🛡️',
    title: 'Built for real decisions.',
    body: 'State-specific rates, brand-accurate depreciation, and the 20/4/10 affordability rule — so your numbers reflect reality, not dealer math.',
  },
]
